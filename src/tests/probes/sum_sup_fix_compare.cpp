...
int main() {
    ...
    const std::vector<CaseSpec> cases = {
        {"baseline_det", "src/tests/correctness_tests/inputs/baseline_det.txt", true, true, true},
        {"baseline_fractional", "src/tests/correctness_tests/inputs/baseline_fractional.txt", true, true, true},
        {"deep_nondet_binary", "src/tests/correctness_tests/inputs/deep_nondet_binary.txt", true, false, true},
        {"positive_only_nondet", "src/tests/correctness_tests/inputs/positive_only_nondet.txt", true, false, true},
        {"child_pump_loop", "src/tests/correctness_tests/inputs/child_pump_loop.txt", false, true, false},
        {"epsilon_boundary", "src/tests/correctness_tests/inputs/epsilon_boundary.txt", true, true, true},
        {"sup_initial_final_child", "src/tests/correctness_tests/inputs/sup_initial_final_child.txt", true, false, true},
        {"split_witness_issue5_phase_same_step_control",
         "src/tests/correctness_tests/inputs/split_witness_issue5_phase_same_step_control.txt", true, false, true},
        {"split_witness_issue5_phase_async_idle",
         "src/tests/correctness_tests/inputs/split_witness_issue5_phase_async_idle.txt", true, false, true},
        {"split_witness_issue5_phase_async_active_false_negative",
         "src/tests/correctness_tests/inputs/split_witness_issue5_phase_async_active_false_negative.txt", true, false, true},
        {"split_witness_issue2_limsup_false_positive",
         "src/tests/correctness_tests/inputs/split_witness_issue2_limsup_false_positive.txt", true, false, true},
        {"phase_parent_final_then_empty",
         "src/tests/correctness_tests/inputs/phase_parent_final_then_empty.txt", true, false, true},
        {"threshold_extremal_sumplus_wrong_final_positive",
         "src/tests/correctness_tests/inputs/threshold_extremal_sumplus_wrong_final_positive.txt", true, false, true},
        {"sum_sup_w1_discharge_on_reset",
         "src/tests/correctness_tests/inputs/sum_sup_w1_discharge_on_reset.txt", true, false, true},
        {"sum_sup_witness_immediate_discharge",
         "src/tests/correctness_tests/inputs/sum_sup_witness_immediate_discharge.txt", true, false, true},
        {"sum_sup_w2_discharge_and_respawn",
         "src/tests/correctness_tests/inputs/sum_sup_w2_discharge_and_respawn.txt", true, false, true},
        {"sum_sup_background_blocks_acceptance",
         "src/tests/correctness_tests/inputs/sum_sup_background_blocks_acceptance.txt", true, false, true},
        {"sum_sup_no_nonsilent_after_prefix",
         "src/tests/correctness_tests/inputs/sum_sup_no_nonsilent_after_prefix.txt", true, false, true},
        {"sum_sup_summinus_mixed_sign_abs_cost",
         "src/tests/correctness_tests/inputs/sum_sup_summinus_mixed_sign_abs_cost.txt", false, true, false},
        {"baseline_det_neg", "src/tests/correctness_tests/inputs/baseline_det_neg.txt", false, true, false},
        {"baseline_fractional_neg", "src/tests/correctness_tests/inputs/baseline_fractional_neg.txt", false, true, false},
        {"child_pump_loop_neg", "src/tests/correctness_tests/inputs/child_pump_loop_neg.txt", false, true, false},
        {"epsilon_boundary_neg", "src/tests/correctness_tests/inputs/epsilon_boundary_neg.txt", false, true, false},
        {"phase_parent_final_then_empty_summinus",
         "src/tests/correctness_tests/inputs/phase_parent_final_then_empty_summinus.txt", false, true, false},
        {"threshold_extremal_summinus_wrong_final_low_guess",
         "src/tests/correctness_tests/inputs/threshold_extremal_summinus_wrong_final_low_guess.txt", false, true, false},
    };
