...
int main() {
    ...
    {
        NestedAutomaton* nwa = new NestedAutomaton("examples/nested/request_response.txt");
    ...
    {
        NestedAutomaton* nwa = new NestedAutomaton("examples/nested/priority_tasks.txt");
